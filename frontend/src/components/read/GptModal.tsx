...
import desktop from '../../../public/images/png/desktop.png'
import eyes from '../../../public/images/png/eyes.png'
import monster from '../../../public/images/png/monster.png'
import pick from '../../../public/images/png/pick.png'
import plus from '../../../public/images/svg/plus-circle.svg'
import {
  featuresState,
  gptLoadingState,
  statusOpenState,
...
function Screen1({ onNext }: Screen1Props) {
  ...
  return (
    ...
    >
      ...
      >
        <div>다음</div>
        <Image className="ml-2" src={arrowRightIcon} alt="arrowRight" />
      </button>
      ...
      <ol className="ml-16 mt-4 mb-8 flex w-80 items-center justify-center sm:ml-44">
        <li className="flex w-full items-center text-blue-600 after:inline-block after:h-1 after:w-full after:border-4 after:border-b after:border-blue-100 after:content-[''] dark:text-blue-500 dark:after:border-blue-800">
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-800 lg:h-12 lg:w-12">
            <Image className="h-[20px] w-[20px] " src={monster} alt="monster" />
          </span>
        </li>
        <li className="flex w-full items-center after:inline-block after:h-1 after:w-full after:border-4 after:border-b after:border-gray-100 after:content-[''] dark:after:border-gray-700">
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 lg:h-12 lg:w-12">
            <Image className="h-[20px] w-[20px] " src={desktop} alt="desktop" />
          </span>
        </li>
        <li className="flex w-full items-center after:inline-block after:h-1 after:w-full after:border-4 after:border-b after:border-gray-100 after:content-[''] dark:after:border-gray-700">
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 lg:h-12 lg:w-12">
            <Image className="h-[20px] w-[20px] " src={pick} alt="pick" />
          </span>
        </li>
        <li className="flex w-full items-center">
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 lg:h-12 lg:w-12">
            <Image className="h-[20px] w-[20px] " src={eyes} alt="eyes" />
          </span>
        </li>
      </ol>
      {/* screen1 */}
...
function Screen2({ onPrev, onNext }: Screen2Props) {
      ...
      <div>
        <div className="flex">
          <button
            ...
            type="button"
          >
            <Image className="mr-2" src={arrowLeftIcon} alt="arrowLeft" />
            이전
          </button>
...
function Screen3({ onPrev, onNext }: Screen3Props) {
...
function Screen4({ onPrev, onClickToggleModal }: Screen4Props) {
  ...
  async function toSubmit() {
    ...
    const persistToken =
      typeof window !== 'undefined'
        ? localStorage.getItem('persistToken')
        : null
    const data = {
      plans,
      techStacks,
    ...
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/projects/plans`,
      {
        method: 'POST',
        headers: {
    ...
    if (!res.ok) {
      ...
      console.log(resData)
      setGptLoading(false)
      setModalContent(resData.data.data)
    }
  }
